       ...
       <form className='flex flex-wrap w-full items-start justify-between '>
        <div className='w-1/2'>
            ...
            <div className='w-2/5 flex flex-col items-start'>
                ...
                <textarea className='text-sm h-44 py-1 px-2 w-full rounded outline-none bg-transparent border-[1px] border-gray-400'   name='"' id='"' cols="30" rows="10"></textarea>
                <button className='bg bg-emerald-500 py-2 px-5 hover:bg-emerald-600 rounded text-sm mt-4 w-full'>Create Task</button>
            </div>
        </form>
        </div>
